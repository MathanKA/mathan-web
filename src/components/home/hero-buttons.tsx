...
export function HeroButtons({
  ...
  return (
    ...
    >
      ...
      <Link
        href={primaryHref}
        className="group relative inline-flex items-center justify-center px-8 py-3 font-normal text-white transition-all duration-300 ease-in-out hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 rounded-full"
      >
      ...
      <Link
        ...
        className={cn(
          ...
          "active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30 font-normal text-white"
        )}
      >
        ...
        <span className="relative flex items-center gap-2 font-medium text-zinc-200 group-hover:text-white transition-colors">
          <MessageCircleMore className="w-5 h-5 text-zinc-200 group-hover:text-white transition-colors" />
          Connect
        </span>
      </Link>
    </div>
