  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          animate={{
            background: `radial-gradient(60% 40% at 20% 30%, rgb(var(--accent-color) / 0.12), transparent 60%)`
          }}
          ...
          <div className="col-span-12 md:col-span-4 self-start md:sticky md:top-24 mb-12 md:mb-0">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <span className="text-[10px] md:text-xs font-mono tracking-[0.2em] text-zinc-500 uppercase">
      ...
      <div className="relative flex items-center justify-center">
        ...
        {isActive && (
          <motion.div
            ...
            style={{ backgroundColor: item.theme.accentHex }}
          />
        )}
      </div>
      ...
      <div className="flex flex-col">
        ...
        {isActive && (
          <motion.span
            ...
            className="text-[10px] text-zinc-400 font-mono tracking-tighter"
          >
            {item.tagline}
          </motion.span>
        )}
