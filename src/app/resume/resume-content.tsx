...
export function ResumeContent() {
  return (
    ...
    >
      ...
      <div className="mb-8 flex flex-wrap justify-end gap-3 print:hidden">
        <Button
          variant="outline"
          asChild
          className="bg-white/5 border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300"
        >
          <Link href="/resume.json" target="_blank">
            <code className="text-[10px] mr-2 text-brand-primary">JSON</code>
            DATA_SPEC
          </Link>
        </Button>
        <Button
          variant="default"
          asChild
          className="bg-brand-primary/10 border border-brand-primary/20 hover:bg-brand-primary/20 text-brand-primary hover:text-white transition-all duration-300"
        >
      ...
      <div className="space-y-10 print:space-y-6">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-brand-primary/20 to-transparent blur-sm h-px w-full" />
        </div>

        {/* Summary */}
        <section>
          <h2 className="text-2xl font-bold tracking-tight mb-4 bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">
            Summary
          </h2>
        ...
        {/* Skills */}
        <section>
          <h2 className="text-2xl font-bold tracking-tight mb-6 bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">
            Technical Skills
          </h2>
        ...
        <section>
          <h2 className="text-xl font-bold tracking-tight mb-4 bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">
          ...
          <div className="grid gap-6 md:grid-cols-2 print:grid-cols-1">
            {resumeData.additionalExperience.map((role, index) => (
              <Card
                key={index}
                className="shadow-none border-white/10 bg-white/5 backdrop-blur-md print:border hover:border-brand-primary/30 transition-all duration-300"
              >
