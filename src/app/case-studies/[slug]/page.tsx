          ...
          <div className="min-w-0">
             ...
             <div className="mb-12 space-y-6 border-b pb-12">
                <div className="flex flex-wrap gap-2 items-center">
                    <Badge variant={post.status === "pilot" ? "secondary" : "default"} className="uppercase tracking-wider text-[10px]">
                        {post.status}
                    </Badge>
             ...
             <div className="mt-16 pt-8 border-t">
                 ...
                 <div className="flex flex-wrap gap-2">
                     {post.stack.map(tech => (
                         <Badge key={tech} variant="secondary" className="px-3 py-1 text-sm bg-muted-foreground/10 hover:bg-muted-foreground/20">
                             {tech}
                         </Badge>
                     ))}
                 </div>
